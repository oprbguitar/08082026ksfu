...
const I18N = (function () {
  ...
  const DIC = {
    ...
    "pgg.explica":    { es:"El decreto, explicado", en:"The decree, explained" },
    "pgg.queEs":      { es:"¿De qué se trata?", en:"What is it?" },
    "pgg.porQue":     { es:"¿Por qué ahora?", en:"Why now?" },
    "pgg.cuando":     { es:"¿Cuándo se aprobó y desde cuándo rige?",
                        en:"When was it approved and since when is it in force?" },
    "pgg.obliga":     { es:"¿A quién obliga?", en:"Who is bound by it?" },
    "pgg.acciones":   { es:"¿Qué acciones manda?", en:"What actions does it mandate?" },
    "pgg.alcance":    { es:"Alcance: qué hace y qué no hace",
                        en:"Scope: what it does and what it does not do" },
    "pgg.si":         { es:"Lo que sí hace", en:"What it does" },
    "pgg.no":         { es:"Lo que no hace", en:"What it does not do" },
    "pgg.lecturas":   { es:"Doble lectura del texto", en:"Two readings of the text" },
    "pgg.lecturasSub":{ es:"Lo que el texto dice, y el margen que deja abierto. Sin calificar la política.",
                        en:"What the text says, and the room it leaves open. Without judging the policy." },
    "pgg.literal":    { es:"Lo que dice", en:"What it says" },
